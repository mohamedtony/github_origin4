...
ProfileAdvertiserStopSettings _$ProfileAdvertiserStopSettingsFromJson(
    ...
    ProfileAdvertiserStopSettings(
      ...
      stop_from: json['stop_from'] == null
          ? null
          : DateTime.parse(json['stop_from'] as String),
      stop_to: json['stop_to'] == null
          ? null
          : DateTime.parse(json['stop_to'] as String),
...
Map<String, dynamic> _$ProfileAdvertiserStopSettingsToJson(
    ...
    <String, dynamic>{
      ...
      'stop_from': instance.stop_from?.toIso8601String(),
      'stop_to': instance.stop_to?.toIso8601String(),
