...
class FindAdvertiseItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(
            color: findAdvertiseController.indexClicked==index?Color(0xFFFFCC99):Colors.grey[300]!,
            blurRadius: 4,
            offset: Offset(0, 3), // S
            spreadRadius:findAdvertiseController.indexClicked==index?4:2// hadow position
        ),
      ],
    ),
    margin:
