...
//=========================================================================================
class CoponItemTap extends StatelessWidget {
  int? pos;
  CoponItemTap({Key? key,this.pos,this.coponModelResponse}) : super(key: key);
  CoponModelResponse? coponModelResponse;
  AdvertiserProfileOrderController controller = Get.find();
  @override
  Widget build(BuildContext context) {
    return GetBuilder<AdvertiserProfileOrderController>(
        init: controller,
                              ...
                              child: Container(
                                //width: 130.0,
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      GetBuilder<AdvertiserProfileOrderController>(
                                          init: controller,
                                          builder: (controller)=>
                                              Container(
                                                  margin: EdgeInsets.all(4.0),
