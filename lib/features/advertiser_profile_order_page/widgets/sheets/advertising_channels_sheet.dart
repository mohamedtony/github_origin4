...
class _AdvertisingChannelsPageState extends State<AdvertisingChannelsPage> {
  ...
  void initState() {
    // TODO: implement initState
     //print("sss= "+advertiserProfileController.showInPlatform.value.toString());
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    crossAxisCount: 3,
                ...
                itemBuilder: (context, index) => Obx(()=>InkWell(
                  onTap: () => advertiserProfileController.changeTabIndex(index, true),
                  child: Container(
                    //margin: const EdgeInsets.all(15.0),
                    // padding: const EdgeInsets.all(3.0),
                    decoration: advertiserProfileController.channels[index].isTapped!=null && advertiserProfileController.channels[index].isTapped.isTrue
                        ? BoxDecoration(
                      border: Border.all(
                          color:
                    ...
                    child: Container(
                      ...
                      child: /*advertiserProfileController.channels.value[index].image!=null&& *//*advertiserProfileController.channels.value[index].image!.isNotEmpty?*/
                      CachedNetworkImage(
                        ...
                        advertiserProfileController.images[index],
                        fit: BoxFit.cover,
                        height: 50.0,
                        width: 30.0,
                      )*/,
              ...
              Obx(()=>InkWell(
                onTap: (){
                  advertiserProfileController.switchShowInPlatform();
                },
                child: Container(
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                      onTap: ()=> advertiserProfileController.onSaveChannelsClicked(context),
                      child: Material(
                        elevation: 6.0,
  ...
  void dispose() {
    ...
    if(advertiserProfileController.isChannelSaveClicked.isFalse){
      advertiserProfileController.channelsIds = [];
      advertiserProfileController.showInPlatform.value = false;
      advertiserProfileController.channels.forEach((element) {
