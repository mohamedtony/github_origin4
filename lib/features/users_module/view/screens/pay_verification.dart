                   ...
                   SizedBox(
                     child: RichText(
                       text: TextSpan(
                         ...
                         children: <TextSpan>[
                           TextSpan(
                               text: _chooseBakaController.createSubscriptionModel?.subscription?.name??'',
                               style: TextStyle(
                                   fontSize: 19.sp,
                   ...
                   SizedBox(
                     child: RichText(
                       text: TextSpan(
                         ...
                         children: <TextSpan>[
                           TextSpan(
                               text: (_chooseBakaController.createSubscriptionModel?.period?.months_count?.toString()??'') + ' أشهر ',
                               style: TextStyle(
                                   fontSize: 19.sp,
                                   color: AppColors.fontColorBlue,
                                   fontFamily: 'Arabic-Regular')),
                   ...
                   SizedBox(
                     child: RichText(
                       text: TextSpan(
                         ...
                         children: <TextSpan>[
                           TextSpan(
                               text: _chooseBakaController.createSubscriptionModel?.period?.free_days?.toString()??'',
                               style: TextStyle(
                                   fontSize: 19.sp,
                                   color: AppColors.fontColorBlue,
                                   fontFamily: 'Arabic-Regular')),
                     ...
                     SizedBox(
                       child: RichText(
                         text: TextSpan(
                           ...
                           children: <TextSpan>[
                             TextSpan(
                                 text: _chooseBakaController.createSubscriptionModel?.period?.price?.toString()??'',
                                 style: TextStyle(
                                     fontSize: 19.sp,
                                     color: AppColors.fontColorBlue,
                                     fontFamily: 'Arabic-Regular')),
                     ...
                     SizedBox(
                       child: RichText(
                         text: TextSpan(
                           ...
                           children: <TextSpan>[
                             TextSpan(
                                 text: _chooseBakaController.createSubscriptionModel?.added_tax?.toString()??'',
                                 style: TextStyle(
                                     fontSize: 19.sp,
                                     color: AppColors.fontColorBlue,
                                     fontFamily: 'Arabic-Regular')),
                     ...
                     SizedBox(
                       child: RichText(
                         text: TextSpan(
                           ...
                           children: <TextSpan>[
                             TextSpan(
                                 text: _chooseBakaController.createSubscriptionModel?.discount?.toString()??'',
                                 style: TextStyle(
                                     fontSize: 19.sp,
                                     color: AppColors.fontColorBlue,
                                     fontFamily: 'Arabic-Regular')),
                       ...
                       child: RichText(
                         text: TextSpan(
                           ...
                           children: <TextSpan>[
                             TextSpan(
                                 //text: '       660             رس ',
                                 text: '                   '+(_chooseBakaController.createSubscriptionModel?.total?.toString()??'')+ ' رس  ',
                                 style: TextStyle(
                                     fontSize: 19.sp,
                                     color: AppColors.bakaPriceColor,
                                     fontFamily: 'Arabic-Regular',
                     ...
                     child: Expanded(
                       child: Row(
                         ...
                         children: [
                           ...
                           Obx(()=>CircleAvatar(radius:20 ,backgroundColor: _chooseBakaController.paymentIndex.value==1?AppColors.blueAccentColor:AppColors.whiteColor,),),
