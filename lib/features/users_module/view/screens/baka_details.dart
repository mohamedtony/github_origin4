...
import 'package:advertisers/features/users_module/view/screens/baka_details2.dart';
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                              child: Obx(()=>Text(
                                _bakaDetailsController.subscriptionBakaDetail.value.first_period?.free_txt??'',
                                style: TextStyle(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                            child:  Obx(()=> _bakaDetailsController.subscriptionBakaDetail.value.commission!=null?Text(
                              ' نقاط المعلن : ${(_bakaDetailsController.subscriptionBakaDetail.value.commission?.toString()??" 0 ")} % من عمولة المنصة للفواتير المدفوعة داخل المنصة ',
                              style: TextStyle(
                                  fontSize: 18.sp,
                                  color: AppColors.arrowBlueColor),
                            ):SizedBox()
