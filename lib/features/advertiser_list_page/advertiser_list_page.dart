...
class AdvertiserListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:ListView(
        children: [
          controller.showSettings? AdvertiseListItem(icon: 'images/setting_icon.svg',title: 'اعدادات الحساب التجارى',listTilePressed: (){
            Get.toNamed('/AdvertiserSettingsPage');
          },):const SizedBox(),
          controller.showAdsRequests?AdvertiseListItem(icon: 'images/menu_icon.svg',title: 'الطلبات',listTilePressed: (){
            Get.toNamed('/AdvertisingRequestsPage');
          },):const SizedBox(),
          controller.showMyAds?AdvertiseListItem(icon: 'images/my_ads_icon.svg',title: 'اعلاناتى',listTilePressed: (){
          ...
          controller.showGallery?AdvertiseListItem(icon: 'images/gallery_icon.svg',title: 'المعرض',listTilePressed: (){
            Get.toNamed('/GalleryPage');
          },):const SizedBox(),
          controller.showReports?AdvertiseListItem(icon: 'images/report_icon.svg',title: 'التقارير',listTilePressed: (){
            Get.toNamed('/CommentsPage');
          },):const SizedBox(),

         controller.showEmployees? AdvertiseListItem(icon: 'images/person_icon.svg',title: 'الموظفين',listTilePressed: (){
            Get.toNamed('/EmployeesPage');
          },):const SizedBox(),
          controller.showSubscriptions?AdvertiseListItem(icon: 'images/subscribe_icon.svg',title: 'الاشتراكات',listTilePressed: (){
            print('pressed2');
          },):const SizedBox(),
          controller.showEmployeesManagement?AdvertiseListItem(icon: 'images/manage_icon.svg',title: 'ادارة حسابات المعلنين',listTilePressed: (){
            print('pressed2');
          },):const SizedBox(),
