                        ...
                        Positioned(
                            ...
                            child:  Row(
                              children: [
                                InkWell(
                                  onTap: (){
                                    controller.removeFromCoastsList(controller.coastList[index]);
                                  },
                                  child: Container(
                                    height: 25,
                                    width: 25,
                        ...
                        Positioned(
                          ...
                          child:  Row(
                            children: [
                              InkWell(
                                onTap: (){
                                  controller.removeFromDiscountList(controller.discountList[index]);
                                },
                                child: Container(
                                  height: 25,
                                  width: 25,
                                        ...
                                        child: Container(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Expanded(child: Row(
                                                  children: [
                                                    Expanded(child: Text("${static[index].title}",style: TextStyle(fontSize: 14.sp,),)),
                                                    Text("${static[index].percentage}",style: TextStyle(fontSize: 14.sp,),),
                                                   const SizedBox(
                                                      width: 8,
                                                    ),
                                                  ],
                                      ...
                                      child: Center(
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text("${static[index].value}",style: TextStyle(fontSize: 12.sp,color:const Color(0xffc87e51)),),
                                            const Spacer(),
                                            Text("ر.س",style: TextStyle(fontSize: 12.sp,color:const Color(0xffc87e51)),),
                                            const SizedBox(
                                              width: 10,
                 ...
                 children: [
                   Row(
                     children: [
                       ...
                       Text("الصافي",style: TextStyle(fontSize: 16.sp,color: Color(0xffD37A47),fontWeight: FontWeight.bold),),
                       const SizedBox(
                         width: 10,
                       ),
                       Text("${controller.sum??0}",style: TextStyle(fontSize: 16.sp,color: Color(0xffD37A47),fontWeight: FontWeight.bold),),
                       const SizedBox(
                         width: 10,
                       ),
                   ...
                   Row(
                     children: [
                       ...
                       Text("الاجمالي",style: TextStyle(fontSize: 16.sp,color: Color(0xffD37A47),fontWeight: FontWeight.bold),),
                       const SizedBox(
                         width: 10,
                       ),
                       Text("${controller.sumTotal?? 0}",style: TextStyle(fontSize: 16.sp,color: Color(0xffD37A47),fontWeight: FontWeight.bold),),
                       const SizedBox(
                         width: 10,
                       ),
                       Text("رس",style: TextStyle(fontSize: 14.sp,),),
