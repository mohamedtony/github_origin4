...
class VerificationEmailPage extends StatelessWidget {
                ...
                SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Text("أكد الايميل الالكترونى "+' '+Get.parameters['email'].toString(),
                          style: TextStyle(
                              fontSize: 20.sp,
                  ...
                  child: SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: Align(
                        ...
                        child: Text("تم إرسال رسالة التحقق إلى هذا الايميل! ${Get.parameters["email"]}",
                  ...
                  child: PinCodeTextField(
                    ...
                    onChanged: (value) {
                      *//* if(Get.parameters['route'].toString()=='registerPhone'){
                      ...
                      Get.find<ClientSettingPageController>().smsOTP.value = value;
                      Get.find<ClientSettingPageController>().publicSmsOtp.value=value;
                      print(value);
                      // setState(() {
                      //   currentText = value;
                      // });
               ...
               /* SizedBox(
                ...
                Padding(
                  ...
                  child: AdvertisersButton(
                      text: 'لم يصلك أى ايميل إلى الان؟ إرسال مرة اخرى',
                      onPressed: () async{
  ...
  Future<void> saveCode() async {
    ...
    PhoneAuthCredential credential = PhoneAuthProvider.credential(verificationId: Get.parameters['verificationId'].toString(), smsCode: controller.pinCodeController!.text);
