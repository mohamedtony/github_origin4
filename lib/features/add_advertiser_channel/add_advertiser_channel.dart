    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
            ...
            child: Row(
              children: [
                Obx(() => QudsPopupButton(
                      ...
                      tooltip: 'اختر قناة',
                      items: getMenuItems(
                          _addAdvertiserChannelController.basicChannels),
                      //           :[QudsPopupMenuWidget(
                      // builder: (c) =>SizedBox())],
                      child: _addAdvertiserChannelController
                                  .choosedChannel.value !=
                              ''
                          ? Obx(() => Image.network(
          ...
          Form(
            key: _addAdvertiserChannelController
                .addAdvertiserChannelControllerKeyForm,
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        ...
                        // validator: (val) {
                        //   return _addAdvertiserChannelController
                        //       .validateAccountName(val ?? '');
                        // },
                        // cursorColor: Colors.black,
                        // keyboardType: inputType,
                        // textDirection: TextDirection.rtl,
                        controller: _addAdvertiserChannelController
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        ...
                        // textDirection: TextDirection.rtl,
                            onChanged: (val){
                              _addAdvertiserChannelController.validateLink(val);
                            },
                        controller:
                            _addAdvertiserChannelController.linkController,
                        decoration: const InputDecoration(
                          border: InputBorder.none,
                          focusedBorder: InputBorder.none,
                          enabledBorder: InputBorder.none,
                        ...
                        child: DropdownButton<String>(
                          ...
                          onChanged: (newVal) {
                            setState(() {
                              ...
                              if (int.parse(_addAdvertiserChannelController
                                          .selectedMenPercentage.value) +
                                      int.parse(_addAdvertiserChannelController
            ...
            child: Row(
              children: [
                Expanded(
                    child: InkWell(
                  onTap: () {
                    if(_addAdvertiserChannelController.linkMes.value==''){
                    _addAdvertiserChannelController.addChannel();
                    Get.delete<AdvertisingInfluenceChannelsController>();
                  }else {
    Get.snackbar(
    "خطأ",
    _addAdvertiserChannelController.linkMes.value,
      ...
      channelsWidgets.add(SizedBox(
        ...
        child: Row(
          children: [
            IconButton(
                onPressed: () {
                  _addAdvertiserChannelController.choosedChannel.value =
                      chan.image ?? '';
                  _addAdvertiserChannelController.channelId.value =
                      chan.id ?? 0;
                  Get.back();
                },
