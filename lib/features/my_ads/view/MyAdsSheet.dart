...
//=========================================================================================
class MyAdsSheet extends StatefulWidget {
    ScrollController? scrollController;

    String? type;
MyAdsSheet({Key? key, this.scrollController,this.type}) : super(key: key);

    @override
    State<MyAdsSheet> createState() => _MyAdsSheetState();
}

class _MyAdsSheetState extends State<MyAdsSheet> {

  MyAddsController findOrderAdvertisersController = Get.put(MyAddsController());

    @override
    void initState() {
        // TODO: implement initState
        super.initState();
       if( findOrderAdvertisersController
            .isFilterSavedClicked
            .isFalse ) {
         Get.find<MyAddsController>().getAdsForm(context);
       }
    }
...
//--------------------------  six section حفظ استعادة--------------------
    ...
    void dispose() {
      ...
      if(findOrderAdvertisersController.isFilterSavedClicked.isFalse) {
        ...
        findOrderAdvertisersController.getMyRequestsFilterForm.value = GetMyRequestsFilterForm();
