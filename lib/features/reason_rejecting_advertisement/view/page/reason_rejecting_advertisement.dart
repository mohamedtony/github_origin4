...
class ReasonRejectingAdvertisement extends StatelessWidget {
  ...
  ReasonRejectingAdvertisementController reasonRejectingAdvertisementController=Get.find();
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(reasonRejectingAdvertisementController.requestId.toString()??'',style: TextStyle(color: Colors.white),)
                            ],
                          ),
                          const  SizedBox(
                            height: 15,
                          ...
                          Row(
                            children:  [
                              InkWell(
                                  onTap: ()async{
                                    if (!await launch("tel:${reasonRejectingAdvertisementController.myRefuseReason.data?.advertiser?.phone??''}")) throw 'Could not launch PhoneCall';
                              ...
                              InkWell(
                                  onTap: ()async{
                                    await openwhatsapp(context,reasonRejectingAdvertisementController.myRefuseReason.data?.advertiser?.phone);
                              ...
                              Card(
                                ...
                                child:  ClipRRect(
                                  ...
                                  child: Image.network('https://roshah.com/wp-content/uploads/2018/04/2986-1.jpg',
                                   // reasonRejectingAdvertisementController.myRefuseReason.data?.user?.image??'',
                                    height: 50.w,
                                    width: 50.w,
                                  ),
                                ),
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(child: Text(reasonRejectingAdvertisementController.myRefuseReason.data?.reason??'',style: TextStyle(color:const Color(0xff6D6B6B),fontSize: 13.sp),),)
                              ],
                            ),),
                          const  SizedBox(
                            height: 20,
                              ...
                              children: [
                                ...
                                Expanded(child: InkWell(onTap: (){
                                  ...
                                  child: Container(
                                    height: 40,
                                    child: Center(
                                      child: Text("اعادة التسعير",style: TextStyle(color: Color(0xff244094),fontSize: 16.sp,),),
                                    ),
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(8),
