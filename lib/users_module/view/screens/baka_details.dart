...
import 'package:advertisers/users_module/view/cards/advantages_baka_card.dart';
...
class BakaDetails extends StatelessWidget {
  ...
  buildItems(){
    ...
    return blocOfWidgets;
      // itemsAsWidgetst.add( items[i],
      // );
     // print(itemsAsWidgets.length%9);
    //   if(itemsAsWidgetst.length%9==0){
    //    // for(int i=0;i<itemsAsWidgetst.length;i++) {
    //       print(itemsAsWidgetst.length);
    //       blocOfWidgetst.add(itemsAsWidgetst.toList());
    //        //blocOfWidgetst[counter].add(itemsAsWidgetst);
    //       counter++;
    //       itemsAsWidgetst.clear();
    //     //}
    //   }else if(blocOfWidgetst.isNotEmpty&&itemsAsWidgetst.isNotEmpty&&counter>0&&itemsAsWidgetst.length<9){
    //     blocOfWidgetst.add(itemsAsWidgetst.toList());
    //    // blocOfWidgetst.addAll(itemsAsWidgetst);
    //     //counter++;
    //     print(itemsAsWidgetst.length);
    //   }
    // }
    // print('>>>>>>>>>>>>>>>>>>>>>>>>> ${blocOfWidgetst}');
    // return blocOfWidgetst;
  }
