...
class RegisterPhoneController extends GetxController{
  GlobalKey<FormState> registerNewClientUser=GlobalKey<FormState>();
  ...
  void checkLogin(){
    final isValid=registerNewClientUser.currentState!.validate();
    if(!isValid){
      return;
    }
    registerNewClientUser.currentState!.save();
    // loginClient();
